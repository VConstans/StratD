...
*/
				if(id == 1)
					...
					vole(1,new Ressource("petrole",2));
/*
			}
			if(RbR)
			{
...
//			System.out.println("Demande impossible");
	...
	synchronized private void vole(int j,Ressource r)
	{
		...
		{
			case 1:
				System.out.println(id+") ressource "+r.type+" avant vole "+ressource.get(r.type));
				...
				else
				{
					...
					System.out.println(id+") ressource après vole "+ressource.get(r.type));
